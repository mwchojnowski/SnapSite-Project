  ...
  return (
    <>
      ...
      <MainBlock
        ...
        text="SnapSite empowers brands to create the digital experience they want their customers to experience.  Creating that experience is easy with SnapSiteSnapSite."
        Button="Get Started"
        href="/Platforms"
        first={true}
      />
